...
test("Verify lookup of 0800ev18hp3m2000", async () => {
    ...
    expect(posisjon[2]?.beregnetVegreferanse).toBe( "0800 EV18 hp3 m2000");
    expect(posisjon[2]?.vegsystemreferanse).toBe("Ukjent vegsystemreferanse");
    expect(posisjon[2]?.relativPosisjon).toBeCloseTo(0.4909, 4) ;
    ...
    expect(posisjon[4]?.vegsystemreferanse).toBe("EV18 S25D1 m2104");
    expect(posisjon[4]?.relativPosisjon).toBeCloseTo(0.4727, 4) ;
